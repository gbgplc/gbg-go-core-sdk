 ...
 * Get Tasks Schema
 */
export function tasksListSchema(
  client: GoCore,
  request?: operations.GetTasksSchemaRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetTasksSchemaResponse,
    | GoError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetTasksSchemaRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/journey/task/list/schema")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetTasksSchemaResponse$inboundSchema),
