 ...
 * Submit Interaction
 */
export function interactionsSubmit(
  client: GoCore,
  ...
  Result<
    operations.SubmitInteractionResponse,
    | GoError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.SubmitInteractionRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/journey/interaction/submit")();
    ...
    [
      {
        ...
        type: "http:bearer",
        value: security?.interactionAccess,
      },
    ],
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.SubmitInteractionResponse$inboundSchema),
