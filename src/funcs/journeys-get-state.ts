 ...
 * Get State Data
 */
export function journeysGetState(
  client: GoCore,
  request?: operations.GetJourneyStateRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetJourneyStateResponse,
    | GoError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.GetJourneyStateRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/journey/state/fetch")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetJourneyStateResponse$inboundSchema),
