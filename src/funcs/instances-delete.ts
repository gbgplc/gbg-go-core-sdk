...
export function instancesDelete(
  ...
  Result<
    operations.DeleteInstanceResponse,
    | GoError
...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(operations.DeleteInstanceRequest$outboundSchema),
        value,
      ),
  ...
  const path = pathToFunc("/journey/state/delete")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteInstanceResponse$inboundSchema),
