...
```typescript
import { UpdateTaskDocumentRelatedPerson } from "@gbg/go-core/models/operations";

let value: UpdateTaskDocumentRelatedPerson = {
...
| `relationship`                                                                                            | [operations.UpdateTaskDocumentRelationship](../../models/operations/update-task-document-relationship.md) | :heavy_check_mark:                                                                                        | N/A                                                                                                       |