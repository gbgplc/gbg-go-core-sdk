...
```typescript
import { StartJourneyDocumentRelatedPerson } from "@gbg/go-core/models/operations";

let value: StartJourneyDocumentRelatedPerson = {
  relationship: "mother",
};
```
...
| `relationship`                                                                                                | [operations.StartJourneyDocumentRelationship](../../models/operations/start-journey-document-relationship.md) | :heavy_check_mark:                                                                                            | N/A                                                                                                           |