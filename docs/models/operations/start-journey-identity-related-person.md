...
```typescript
import { StartJourneyIdentityRelatedPerson } from "@gbg/go-core/models/operations";

let value: StartJourneyIdentityRelatedPerson = {
...
| `relationship`                                                                                                | [operations.StartJourneyIdentityRelationship](../../models/operations/start-journey-identity-relationship.md) | :heavy_check_mark:                                                                                            | N/A                                                                                                           |