...
```java
import com.gbg.gocore.models.operations.FetchInteractionAuthType;

FetchInteractionAuthType value = FetchInteractionAuthType.ACTIVE_AUTHENTICATION;

// Open enum: use .of() to create instances from custom string values
FetchInteractionAuthType custom = FetchInteractionAuthType.of("custom_value");
```
