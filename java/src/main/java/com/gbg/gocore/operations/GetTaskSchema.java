...
public class GetTaskSchema {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTaskSchemaRequest, GetTaskSchemaResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTaskSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetTaskSchemaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTaskSchemaRequest request) {
        ...
        @Override
        public GetTaskSchemaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTaskSchemaResponse.Builder resBuilder =
            ...
            GetTaskSchemaResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTaskSchemaRequest, com.gbg.gocore.models.operations.async.GetTaskSchemaResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTaskSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetTaskSchemaRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTaskSchemaRequest request) {
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.GetTaskSchemaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.GetTaskSchemaResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.GetTaskSchemaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gbg.gocore.models.operations.async.GetTaskSchemaResponse res = resBuilder.build();
