...
public class UpdateTask {
    ...
    static abstract class Base {
        ...
        final UpdateTaskSecurity security;
        final SecuritySource securitySource;
        final HTTPClient client;
        final Headers _headers;

        public Base(
                @Nonnull SDKConfiguration sdkConfiguration, @Nonnull UpdateTaskSecurity security,
                Headers _headers) {
    ...
    public static class Sync extends Base
            implements RequestOperation<UpdateTaskRequest, UpdateTaskResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nonnull UpdateTaskSecurity security,
                Headers _headers) {
            super(
        ...
        private HttpRequest onBuildRequest(UpdateTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateTaskRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(UpdateTaskRequest request) {
        ...
        @Override
        public UpdateTaskResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            UpdateTaskResponse.Builder resBuilder =
                    UpdateTaskResponse
                            .builder()
            ...
            UpdateTaskResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<UpdateTaskResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<UpdateTaskRequest, com.gbg.gocore.models.operations.async.UpdateTaskResponse> {
        ...
        private CompletableFuture<HttpRequest> onBuildRequest(UpdateTaskRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<UpdateTaskRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(UpdateTaskRequest request) {
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.UpdateTaskResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.UpdateTaskResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.UpdateTaskResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gbg.gocore.models.operations.async.UpdateTaskResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<UpdateTaskResponseBody>() {})
