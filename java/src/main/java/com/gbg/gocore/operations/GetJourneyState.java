...
public class GetJourneyState {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetJourneyStateRequest, GetJourneyStateResponse> {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetJourneyStateRequest request) {
        ...
        @Override
        public GetJourneyStateResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetJourneyStateResponse.Builder resBuilder =
            ...
            GetJourneyStateResponse res = resBuilder.build();
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetJourneyStateRequest, com.gbg.gocore.models.operations.async.GetJourneyStateResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetJourneyStateRequest request) {
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.GetJourneyStateResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.GetJourneyStateResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.GetJourneyStateResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gbg.gocore.models.operations.async.GetJourneyStateResponse res = resBuilder.build();
