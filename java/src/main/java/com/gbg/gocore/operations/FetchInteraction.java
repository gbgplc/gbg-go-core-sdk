...
public class FetchInteraction {

    static abstract class Base {
        final SDKConfiguration sdkConfiguration;
        final String baseUrl;
        final FetchInteractionSecurity security;
        final SecuritySource securitySource;
        final HTTPClient client;
        final Headers _headers;

        public Base(
                @Nonnull SDKConfiguration sdkConfiguration, @Nonnull FetchInteractionSecurity security,
                Headers _headers) {
    ...
    public static class Sync extends Base
            implements RequestOperation<FetchInteractionRequest, FetchInteractionResponse> {
        public Sync(
                @Nonnull SDKConfiguration sdkConfiguration, @Nonnull FetchInteractionSecurity security,
                Headers _headers) {
            super(
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FetchInteractionRequest request) {
        ...
        @Override
        public FetchInteractionResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FetchInteractionResponse.Builder resBuilder =
            ...
            FetchInteractionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withOneOf(Utils.unmarshal(response, new TypeReference<FetchInteractionResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<FetchInteractionRequest, com.gbg.gocore.models.operations.async.FetchInteractionResponse> {
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(FetchInteractionRequest request) {
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.FetchInteractionResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.FetchInteractionResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.FetchInteractionResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gbg.gocore.models.operations.async.FetchInteractionResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<FetchInteractionResponseBody>() {})
