...
public class DeviceConnect {
    ...
    public static class Sync extends Base
        ...
        @Override
        public DeviceConnectResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeviceConnectResponse.Builder resBuilder =
    ...
    public static class Async extends Base
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.DeviceConnectResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.DeviceConnectResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.DeviceConnectResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);
