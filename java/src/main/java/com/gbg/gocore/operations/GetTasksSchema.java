...
import com.gbg.gocore.models.operations.GetTasksSchemaResponseBody;
...
public class GetTasksSchema {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetTasksSchemaRequest, GetTasksSchemaResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private HttpRequest onBuildRequest(GetTasksSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetTasksSchemaRequest>() {});
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetTasksSchemaRequest request) {
        ...
        @Override
        public GetTasksSchemaResponse handleResponse(HttpResponse<InputStream> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetTasksSchemaResponse.Builder resBuilder =
            ...
            GetTasksSchemaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return res.withObject(Utils.unmarshal(response, new TypeReference<GetTasksSchemaResponseBody>() {}));
                } else {
    ...
    public static class Async extends Base
            implements AsyncRequestOperation<GetTasksSchemaRequest, com.gbg.gocore.models.operations.async.GetTasksSchemaResponse> {

        public Async(@Nonnull SDKConfiguration sdkConfiguration, Headers _headers) {
            super(sdkConfiguration, _headers);
        }

        private CompletableFuture<HttpRequest> onBuildRequest(GetTasksSchemaRequest request) throws Exception {
            HttpRequest req = buildRequest(request, new TypeReference<GetTasksSchemaRequest>() {});
        ...
        @Override
        public CompletableFuture<HttpResponse<Blob>> doRequest(GetTasksSchemaRequest request) {
        ...
        @Override
        public CompletableFuture<com.gbg.gocore.models.operations.async.GetTasksSchemaResponse> handleResponse(
                HttpResponse<Blob> response) {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            com.gbg.gocore.models.operations.async.GetTasksSchemaResponse.Builder resBuilder =
                    com.gbg.gocore.models.operations.async.GetTasksSchemaResponse
                            .builder()
                            .contentType(contentType)
                            .statusCode(response.statusCode())
                            .rawResponse(response);

            com.gbg.gocore.models.operations.async.GetTasksSchemaResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    return Utils.unmarshalAsync(response, new TypeReference<GetTasksSchemaResponseBody>() {})
