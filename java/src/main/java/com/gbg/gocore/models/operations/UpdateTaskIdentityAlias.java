...
public class UpdateTaskIdentityAlias {
    /**
    ...
    @JsonCreator
    public UpdateTaskIdentityAlias(
     ...
     * Title of an individual such as Mr, Mrs, Dr, Sir
     */
    public UpdateTaskIdentityAlias withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * A person's name used by their collegues and friends to address them
     */
    public UpdateTaskIdentityAlias withFirstName(@Nullable String firstName) {
        this.firstName = firstName;
        return this;
    }
     ...
     * Any other registered names used by the individual, not aliases
     */
    public UpdateTaskIdentityAlias withMiddleNames(@Nullable List<String> middleNames) {
        this.middleNames = middleNames;
        return this;
    }
     ...
     * Any family names for the individual
     */
    public UpdateTaskIdentityAlias withLastNames(@Nullable List<String> lastNames) {
        this.lastNames = lastNames;
        return this;
    }
     ...
     * Any family names for the individual
     */
    public UpdateTaskIdentityAlias withLastNamesAtBirth(@Nullable List<String> lastNamesAtBirth) {
        this.lastNamesAtBirth = lastNamesAtBirth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTaskIdentityAlias other = (UpdateTaskIdentityAlias) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTaskIdentityAlias.class,
                "title", title,
                "firstName", firstName,
    ...
    public final static class Builder {
        ...
        public UpdateTaskIdentityAlias build() {
            return new UpdateTaskIdentityAlias(
                title, firstName, middleNames,
                lastNames, lastNamesAtBirth);
        }
