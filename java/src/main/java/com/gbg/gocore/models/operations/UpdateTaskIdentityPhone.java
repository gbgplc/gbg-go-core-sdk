...
public class UpdateTaskIdentityPhone {
    /**
    ...
    @JsonCreator
    public UpdateTaskIdentityPhone(
     ...
     * The type of phone number, such as landline, mobile, fax, unknown etc
     */
    public UpdateTaskIdentityPhone withType(@Nonnull String type) {
     ...
     * Phone number, ideally in international format with +(Country Code)
     */
    public UpdateTaskIdentityPhone withNumber(@Nonnull String number) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTaskIdentityPhone other = (UpdateTaskIdentityPhone) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTaskIdentityPhone.class,
                "type", type,
                "number", number);
    }
    ...
    public final static class Builder {
        ...
        public UpdateTaskIdentityPhone build() {
            return new UpdateTaskIdentityPhone(
                type, number);
        }
