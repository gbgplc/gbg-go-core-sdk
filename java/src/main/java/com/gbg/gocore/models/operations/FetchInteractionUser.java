...
public class FetchInteractionUser {
    ...
    public FetchInteractionUser withId(@Nonnull String id) {
        this.id = Utils.checkNotNull(id, "id");
        return this;
    }


    public FetchInteractionUser withEmail(@Nonnull String email) {
        this.email = Utils.checkNotNull(email, "email");
        return this;
    }


    public FetchInteractionUser withDomain(@Nonnull String domain) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        FetchInteractionUser other = (FetchInteractionUser) o;
        return 
    ...
    public String toString() {
        return Utils.toString(FetchInteractionUser.class,
                "id", id,
                "email", email,
                "domain", domain);
    }
    ...
    public final static class Builder {
        ...
        public FetchInteractionUser build() {
            return new FetchInteractionUser(
                id, email, domain);
        }
