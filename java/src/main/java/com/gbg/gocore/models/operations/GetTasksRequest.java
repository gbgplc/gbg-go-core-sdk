...
public class GetTasksRequest {
     ...
     * Journey Instance Id, a unique identifier for a started journey instance.
     */
    public GetTasksRequest withInstanceId(@Nonnull String instanceId) {
    ...
    @JsonAnySetter
    public GetTasksRequest withAdditionalProperty(String key, Object value) {
    ...
    public GetTasksRequest withAdditionalProperties(@Nullable Map<String, Object> additionalProperties) {
    ...
    public String toString() {
        return Utils.toString(GetTasksRequest.class,
