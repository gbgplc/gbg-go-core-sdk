 ...
 * 
 * <p>Delete instance response contains the Journey Instance Id
 */
public class DeleteInstanceResponseBody {
    /**
    ...
    @JsonCreator
    public DeleteInstanceResponseBody(
     ...
     * Journey Instance Id, a unique identifier for a started journey instance.
     */
    public DeleteInstanceResponseBody withInstanceId(@Nonnull String instanceId) {
    ...
    @JsonAnySetter
    public DeleteInstanceResponseBody withAdditionalProperty(String key, Object value) {
    ...
    public DeleteInstanceResponseBody withAdditionalProperties(@Nullable Map<String, Object> additionalProperties) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        DeleteInstanceResponseBody other = (DeleteInstanceResponseBody) o;
        return 
    ...
    public String toString() {
        return Utils.toString(DeleteInstanceResponseBody.class,
    ...
    public final static class Builder {
        ...
        public DeleteInstanceResponseBody build() {
            return new DeleteInstanceResponseBody(
                instanceId)
