...
public class UpdateTaskSessionAuth {
    ...
    public UpdateTaskSessionAuth withId(@Nonnull String id) {
        this.id = Utils.checkNotNull(id, "id");
        return this;
    }


    public UpdateTaskSessionAuth withScope(@Nullable String scope) {
        this.scope = scope;
        return this;
    }


    public UpdateTaskSessionAuth withCodeVerifier(@Nullable String codeVerifier) {
        this.codeVerifier = codeVerifier;
        return this;
    }


    public UpdateTaskSessionAuth withCode(@Nullable String code) {
        this.code = code;
        return this;
    }


    public UpdateTaskSessionAuth withState(@Nullable String state) {
        this.state = state;
        return this;
    }


    public UpdateTaskSessionAuth withRedirectUri(@Nullable String redirectUri) {
        this.redirectUri = redirectUri;
        return this;
    }


    public UpdateTaskSessionAuth withResponseType(@Nullable String responseType) {
        this.responseType = responseType;
        return this;
    }


    public UpdateTaskSessionAuth withClientId(@Nullable String clientId) {
        this.clientId = clientId;
        return this;
    }


    public UpdateTaskSessionAuth withClientSecret(@Nullable String clientSecret) {
        this.clientSecret = clientSecret;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTaskSessionAuth other = (UpdateTaskSessionAuth) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTaskSessionAuth.class,
                "id", id,
                "scope", scope,
    ...
    public final static class Builder {
        ...
        public UpdateTaskSessionAuth build() {
            return new UpdateTaskSessionAuth(
                id, scope, codeVerifier,
                code, state, redirectUri,
                responseType, clientId, clientSecret);
        }
