...
public class StartJourneyUser {
    ...
    public StartJourneyUser withId(@Nonnull String id) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StartJourneyUser other = (StartJourneyUser) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StartJourneyUser.class,
                "id", id,
                "email", email,
                "domain", domain);
    }
    ...
    public final static class Builder {
        ...
        public StartJourneyUser build() {
            return new StartJourneyUser(
                id, email, domain);
        }
