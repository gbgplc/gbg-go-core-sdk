...
public class StartJourneyDocumentPhone {
    /**
    ...
    @JsonCreator
    public StartJourneyDocumentPhone(
     ...
     * The type of phone number, such as landline, mobile, fax, unknown etc
     */
    public StartJourneyDocumentPhone withType(@Nonnull String type) {
     ...
     * Phone number, ideally in international format with +(Country Code)
     */
    public StartJourneyDocumentPhone withNumber(@Nonnull String number) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StartJourneyDocumentPhone other = (StartJourneyDocumentPhone) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StartJourneyDocumentPhone.class,
                "type", type,
                "number", number);
    }
    ...
    public final static class Builder {
        ...
        public StartJourneyDocumentPhone build() {
            return new StartJourneyDocumentPhone(
                type, number);
        }
