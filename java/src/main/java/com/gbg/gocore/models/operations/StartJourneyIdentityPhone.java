...
public class StartJourneyIdentityPhone {
    /**
    ...
    @JsonCreator
    public StartJourneyIdentityPhone(
     ...
     * The type of phone number, such as landline, mobile, fax, unknown etc
     */
    public StartJourneyIdentityPhone withType(@Nonnull String type) {
     ...
     * Phone number, ideally in international format with +(Country Code)
     */
    public StartJourneyIdentityPhone withNumber(@Nonnull String number) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        StartJourneyIdentityPhone other = (StartJourneyIdentityPhone) o;
        return 
    ...
    public String toString() {
        return Utils.toString(StartJourneyIdentityPhone.class,
                "type", type,
                "number", number);
    }
    ...
    public final static class Builder {
        ...
        public StartJourneyIdentityPhone build() {
            return new StartJourneyIdentityPhone(
                type, number);
        }
