...
public class SubmitInteractionUser {
    ...
    public SubmitInteractionUser withId(@Nonnull String id) {
        this.id = Utils.checkNotNull(id, "id");
        return this;
    }


    public SubmitInteractionUser withEmail(@Nonnull String email) {
        this.email = Utils.checkNotNull(email, "email");
        return this;
    }


    public SubmitInteractionUser withDomain(@Nonnull String domain) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubmitInteractionUser other = (SubmitInteractionUser) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SubmitInteractionUser.class,
                "id", id,
                "email", email,
                "domain", domain);
    }
    ...
    public final static class Builder {
        ...
        public SubmitInteractionUser build() {
            return new SubmitInteractionUser(
                id, email, domain);
        }
