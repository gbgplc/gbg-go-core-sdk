...
public class SubmitInteractionIdentityEmail {
    ...
    @JsonCreator
    public SubmitInteractionIdentityEmail(
     ...
     * Email address
     */
    public SubmitInteractionIdentityEmail withEmail(@Nonnull String email) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        SubmitInteractionIdentityEmail other = (SubmitInteractionIdentityEmail) o;
        return 
    ...
    public String toString() {
        return Utils.toString(SubmitInteractionIdentityEmail.class,
                "type", type,
                "email", email);
    }
    ...
    public final static class Builder {
        ...
        public SubmitInteractionIdentityEmail build() {
            return new SubmitInteractionIdentityEmail(
                type, email);
        }
