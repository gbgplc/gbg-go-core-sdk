...
public enum UpdateTaskAuthType {
    ...
    UpdateTaskAuthType(String value) {
        this.value = value;
    }
    ...
    public static Optional<UpdateTaskAuthType> fromValue(String value) {
        for (UpdateTaskAuthType o: UpdateTaskAuthType.values()) {
