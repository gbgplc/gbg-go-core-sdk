...
public class UpdateTaskDocumentAlias {
    /**
    ...
    @JsonCreator
    public UpdateTaskDocumentAlias(
     ...
     * Title of an individual such as Mr, Mrs, Dr, Sir
     */
    public UpdateTaskDocumentAlias withTitle(@Nullable String title) {
        this.title = title;
        return this;
    }
     ...
     * A person's name used by their collegues and friends to address them
     */
    public UpdateTaskDocumentAlias withFirstName(@Nullable String firstName) {
        this.firstName = firstName;
        return this;
    }
     ...
     * Any other registered names used by the individual, not aliases
     */
    public UpdateTaskDocumentAlias withMiddleNames(@Nullable List<String> middleNames) {
        this.middleNames = middleNames;
        return this;
    }
     ...
     * Any family names for the individual
     */
    public UpdateTaskDocumentAlias withLastNames(@Nullable List<String> lastNames) {
        this.lastNames = lastNames;
        return this;
    }
     ...
     * Any family names for the individual
     */
    public UpdateTaskDocumentAlias withLastNamesAtBirth(@Nullable List<String> lastNamesAtBirth) {
        this.lastNamesAtBirth = lastNamesAtBirth;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTaskDocumentAlias other = (UpdateTaskDocumentAlias) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTaskDocumentAlias.class,
                "title", title,
                "firstName", firstName,
    ...
    public final static class Builder {
        ...
        public UpdateTaskDocumentAlias build() {
            return new UpdateTaskDocumentAlias(
                title, firstName, middleNames,
                lastNames, lastNamesAtBirth);
        }
