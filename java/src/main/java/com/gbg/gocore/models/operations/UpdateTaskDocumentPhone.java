...
public class UpdateTaskDocumentPhone {
    /**
    ...
    @JsonCreator
    public UpdateTaskDocumentPhone(
     ...
     * The type of phone number, such as landline, mobile, fax, unknown etc
     */
    public UpdateTaskDocumentPhone withType(@Nonnull String type) {
     ...
     * Phone number, ideally in international format with +(Country Code)
     */
    public UpdateTaskDocumentPhone withNumber(@Nonnull String number) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        UpdateTaskDocumentPhone other = (UpdateTaskDocumentPhone) o;
        return 
    ...
    public String toString() {
        return Utils.toString(UpdateTaskDocumentPhone.class,
                "type", type,
                "number", number);
    }
    ...
    public final static class Builder {
        ...
        public UpdateTaskDocumentPhone build() {
            return new UpdateTaskDocumentPhone(
                type, number);
        }
